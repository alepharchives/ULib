...
#line 21 "test_bison.yy"
{
   int number;
   UFlexerReference ref;
}
/* Line 187 of yacc.c.  */
#line 125 "test_bison.cc"
	YYSTYPE;
...
yyreduce:
  ...
  switch (yyn)
    {
        case 5:
#line 44 "test_bison.yy"
    {
	printf("\t%d\n", (yyvsp[(1) - (2)].number));

   U_INTERNAL_TRACE("UBison::yyparse() <line> %d", (yyvsp[(1) - (2)].number));
}
    break;

  case 6:
#line 52 "test_bison.yy"
    {
	(yyval.number) = (yyvsp[(1) - (1)].number);

	U_INTERNAL_TRACE("UBison::yyparse() <exp NUM> %d", (yyvsp[(1) - (1)].number));
}
    break;

  case 7:
#line 58 "test_bison.yy"
    {
	(yyval.number) = (yyvsp[(1) - (3)].number) + (yyvsp[(3) - (3)].number);

	U_INTERNAL_TRACE("UBison::yyparse() <exp +> %d + %d", (yyvsp[(1) - (3)].number), (yyvsp[(3) - (3)].number));
}
    break;

  case 8:
#line 64 "test_bison.yy"
    {
	(yyval.number) = (yyvsp[(1) - (3)].number) - (yyvsp[(3) - (3)].number);
...
#line 76 "test_bison.yy"
  ...
  case 11:
#line 82 "test_bison.yy"
    {
	(yyval.number) = -(yyvsp[(2) - (2)].number);

	U_INTERNAL_TRACE("UBison::yyparse() <exp NEG> %d", (yyvsp[(2) - (2)].number));
}
    break;

  case 12:
#line 88 "test_bison.yy"
    {
	(yyval.number) = (int) ::pow((float)(yyvsp[(1) - (3)].number), (float)(yyvsp[(3) - (3)].number));
  ...
  case 13:
#line 94 "test_bison.yy"
    {
	(yyval.number) = (yyvsp[(2) - (3)].number);

	U_INTERNAL_TRACE("UBison::yyparse() <exp ()> %d", (yyvsp[(2) - (3)].number));
}
    break;


/* Line 1267 of yacc.c.  */
#line 1419 "test_bison.cc"
      default: break;
    }
