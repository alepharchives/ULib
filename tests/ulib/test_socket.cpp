...
static void PrintIPAddress(const char* pcInformationString, UIPAddress& cAddr)
{
   ...
   printf("%s\n", pcInformationString);
   printf(" - Name    : %s\n", (const char*) cAddr.getHostName().c_str());
...
/******************************************************************************/
static void TCPEchoClient(UIPAddress& cEchoServer, int iPortNumber, const char* pcEchoString, bool bIPv6)
{
   U_TRACE(5, "::TCPEchoClient(%p,%d,%S,%b)", &cEchoServer, iPortNumber, pcEchoString, bIPv6)
   ...
   cClientSocket.socket(SOCK_STREAM);
...
/******************************************************************************/
static void TCPEchoServer(int iPortNumber, bool bIPv6)
{
   U_TRACE(5, "::TCPEchoServer(%d,%b)", iPortNumber, bIPv6)
...
/******************************************************************************/
static void UDPEchoClient(UIPAddress& cEchoServer, int iPortNumber, const char* pcEchoString, bool bIPv6)
{
   U_TRACE(5, "::UDPEchoClient(%p,%d,%S,%b)", &cEchoServer, iPortNumber, pcEchoString, bIPv6)
   ...
   cClientSocket.socket(SOCK_DGRAM);
   cClientSocket.USocket::connectServer(cEchoServer, iPortNumber);
...
/******************************************************************************/
static void UDPEchoServer(int iPortNumber, bool bIPv6)
{
   U_TRACE(5, "::UDPEchoServer(%d,%b)", iPortNumber, bIPv6)
...
int U_EXPORT main(int iArgC, char** ppcArgV)
{
   ...
   // sockp.setLocal(UServer_Base::getSocket()->localIPAddress());
...
#  endif
      ...
      fd_set* mask = sockp.ping(vaddr, false, 0, device);
