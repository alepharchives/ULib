...
int U_EXPORT main(int argc, char* argv[])
{
   ...
   PKCS7* p7 = UPKCS7::sign(U_STRING_FROM_CONSTANT(DATA),
                            U_STRING_FROM_CONSTANT(SIGNERFILE),
                            U_STRING_FROM_CONSTANT(KEYFILE),
                            U_STRING_FROM_CONSTANT(PASSIN),
                            U_STRING_FROM_CONSTANT(CERTFILE));
