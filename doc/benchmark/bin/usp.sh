...
# gcc -DKEEP_ALIVES	 -static local_bench.c	-o local_bench_keepalive    -lpthread
# gcc						 -static local_bench.c	-o local_bench_NO_keepalive -lpthread
...
./bench_NO_keepalive $HOST "/servlet/benchmarking?name=stefano"   8080 0 1000
mv $1/test.txt $1/usp_NO_keepalive.csv

sleep 60

./bench_keepalive    $HOST "/servlet/benchmarking?name=stefano"   8080 0 1000
