...
# 100.html
./bench2_keepalive	gwan $HOST "/100.html" 8080 0 1000
mv $1/test.txt			WEIGHTTP/$1/gwan_100_keepalive.csv
sleep 60
./bench2_NO_keepalive gwan $HOST "/100.html" 8080 0 1000
mv $1/test.txt			WEIGHTTP/$1/gwan_100_NO_keepalive.csv

sleep 60

# 1000.html
./bench2_NO_keepalive gwan $HOST "/1000.html" 8080 0 1000
mv $1/test.txt			WEIGHTTP/$1/gwan_1000_NO_keepalive.csv
sleep 60
./bench2_keepalive	gwan $HOST "/1000.html" 8080 0 1000
mv $1/test.txt			WEIGHTTP/$1/gwan_1000_keepalive.csv

sleep 60

# servlet/benchmarking?name=stefano
./bench2_NO_keepalive gwan $HOST "/csp?hellox.c&name=stefano"   8080 0 1000
mv $1/test.txt			WEIGHTTP/$1/csp_NO_keepalive.csv
sleep 60
./bench2_keepalive   gwan  $HOST "/csp?hellox.c&name=stefano"   8080 0 1000
mv $1/test.txt			WEIGHTTP/$1/csp_keepalive.csv

sleep 60

# ws/flash-bridge/WebSocketMain.swf
./bench2_keepalive   gwan  $HOST "/ws/flash-bridge/WebSocketMain.swf"   8080 0 1000
mv $1/test.txt			WEIGHTTP/$1/gwan_big_keepalive.csv
sleep 60
./bench2_NO_keepalive gwan $HOST "/ws/flash-bridge/WebSocketMain.swf"   8080 0 1000
