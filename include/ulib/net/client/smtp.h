...
public:
   ...
   */
   ...
   bool _connectServer(UFileConfig& file,     int port = 25, uint32_t timeout = U_TIMEOUT_MS);
   bool _connectServer(const UString& server, int port = 25, uint32_t timeout = U_TIMEOUT_MS);
