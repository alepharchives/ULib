...
public:
   ...
   */
   ...
   bool connectServer(const UString& server, int port = 143, uint32_t timeout = U_TIMEOUT);
   ...
   */
   ...
   bool isSTLS(UVector<UString>& v) const { return (v.find(*USocket::str_starttls) != U_NOT_FOUND); }
