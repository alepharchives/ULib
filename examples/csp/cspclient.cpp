...
#undef  PACKAGE
#define PACKAGE "cspclient"

#include "./usage.txt"

#include <ulib/application.h>

template <class T> class UClientCSP : public USOAPClient<T> {
public:
   ...
   public:
      ...
      CSP_CA()
         {
         U_TRACE_REGISTER_OBJECT(5, CSP_CA, "", 0)
   ...
   public:
      ...
      CSP_LIST_CA()
         {
         U_TRACE_REGISTER_OBJECT(5, CSP_LIST_CA, "", 0)
   ...
   public:
      ...
      CSP_SIGN_P10()
         {
         U_TRACE_REGISTER_OBJECT(5, CSP_SIGN_P10, "", 0)
   ...
   public:
      ...
      CSP_SIGN_SPKAC()
         {
         U_TRACE_REGISTER_OBJECT(5, CSP_SIGN_SPKAC, "", 0)
   ...
   public:
      ...
      CSP_LIST_CERTS()
         {
         U_TRACE_REGISTER_OBJECT(5, CSP_LIST_CERTS, "", 0)
   ...
   public:
      ...
      CSP_REMOVE_CERT()
         {
         U_TRACE_REGISTER_OBJECT(5, CSP_REMOVE_CERT, "", 0)
   ...
   public:
      ...
      CSP_ZERO_CERTS()
         {
         U_TRACE_REGISTER_OBJECT(5, CSP_ZERO_CERTS, "", 0)
   ...
   public:
      ...
      CSP_EMIT_CRL()
         {
         U_TRACE_REGISTER_OBJECT(5, CSP_EMIT_CRL, "", 0)
   ...
   public:
      ...
      CSP_GET_CRL()
         {
         U_TRACE_REGISTER_OBJECT(5, CSP_GET_CRL, "", 0)
   ...
   public:
      ...
      CSP_GET_CA()
         {
         U_TRACE_REGISTER_OBJECT(5, CSP_GET_CA, "", 0)
   ...
   public:
      ...
      CSP_REVOKE_CERT()
         {
         U_TRACE_REGISTER_OBJECT(5, CSP_REVOKE_CERT, "", 0)
   ...
   bool creatCA(const UString& n, uint32_t d, const UString& c) // 1
      ...
      if (USOAPClient<T>::processRequest(m_CSP_CA))
         {
   ...
   UString listCA() // 2
      ...
      if (USOAPClient<T>::processRequest(m_CSP_LIST_CA))
         {
   ...
   UString signP10(const UString& n, const UString& k, const UString& p) // 3
      ...
      if (USOAPClient<T>::processRequest(m_CSP_SIGN_P10))
         {
         result = USOAPClient<T>::getResponse(); // Get the value of the element inside the response
         }
   ...
   UString signSPKAC(const UString& n, const UString& k, const UString& p) // 4
      ...
      if (USOAPClient<T>::processRequest(m_CSP_SIGN_SPKAC))
         {
         result = USOAPClient<T>::getResponse(); // Get the value of the element inside the response
         }
   ...
   UString listCerts(const UString& name, uint32_t compress) // 5
      ...
      if (USOAPClient<T>::processRequest(m_CSP_LIST_CERTS))
         {
         result = USOAPClient<T>::getResponse(); // Get the value of the element inside the response
         }
   ...
   bool removeCert(const UString& n, const UString& s) // 6
      ...
      if (USOAPClient<T>::processRequest(m_CSP_REMOVE_CERT))
         {
         int result = USOAPClient<T>::getResponse().strtol(); // Get the value of the element inside the response
   ...
   bool zeroCerts(const UString& name) // 7
      ...
      if (USOAPClient<T>::processRequest(m_CSP_ZERO_CERTS))
         {
         int result = USOAPClient<T>::getResponse().strtol(); // Get the value of the element inside the response
   ...
   bool emitCRL(const UString& name) // 8
      ...
      if (USOAPClient<T>::processRequest(m_CSP_EMIT_CRL))
         {
         int result = USOAPClient<T>::getResponse().strtol(); // Get the value of the element inside the response
   ...
   UString getCRL(const UString& name) // 9
      ...
      if (USOAPClient<T>::processRequest(m_CSP_GET_CRL))
         {
         result = USOAPClient<T>::getResponse(); // Get the value of the element inside the response
         }
   ...
   UString getCA(const UString& name) // 10
      ...
      if (USOAPClient<T>::processRequest(m_CSP_GET_CA))
         {
         result = USOAPClient<T>::getResponse(); // Get the value of the element inside the response
         }
   ...
   bool revokeCert(const UString& n, const UString& s) // 11 
      ...
      if (USOAPClient<T>::processRequest(m_CSP_REVOKE_CERT))
         {
         int result = USOAPClient<T>::getResponse().strtol(); // Get the value of the element inside the response
