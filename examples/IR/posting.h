...
private:
   ...
   static       void     print(UStringRep* word_rep, UStringRep* value) U_NO_EXPORT;
   static       void     substitute(UStringRep* word_rep, UStringRep* value) U_NO_EXPORT;
   static       void     checkAllEntry(UStringRep* word_rep, UStringRep* value) U_NO_EXPORT;
   static       void     checkDocument(UStringRep* word_rep, UStringRep* value) U_NO_EXPORT;
   static       void     printDocName(UStringRep* doc_id, UStringRep* doc_name) U_NO_EXPORT;

   // Forbidden operations

   UPosting(const UPosting& p)            {}
   UPosting& operator=(const UPosting& p) { return *this; }
};
