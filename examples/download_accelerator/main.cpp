...
#define APPEND_LITERAL(s) (void) u_memcpy(p, s, sizeof(s) - 1); p += sizeof(s) - 1;
...
public:
   ...
   bool sendProbe()
      ...
      (void) u_memcpy(&ip->ip_dst, host->ip.get_in_addr(), host->ip.getInAddrLength()); /* remote address */
   ...
   bool results()
      ...
      unsigned n = numhosts, score, lowest_score;
