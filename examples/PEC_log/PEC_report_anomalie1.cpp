...
#     endif
   ...
   static void* MessageToString(Messaggio* msg, bool* bdelete)
      ...
      *bdelete        = true;
      UStringRep* rep = (UStringRep*) UObject2StringRep<Messaggio>(msg);
   ...
   static void findKeyOnDatabase(UStringRep* key, Messaggio* msg)
      {
      ...
      U_INTERNAL_DUMP("old_start = %ld, msg->start = %ld, new_ttl = %ld", old_start, msg->start, new_ttl)
...
"NUMBER OF MESSAGES OUT OF TTL RANGE.: <%u> (TTL range read as parameter: %ld days)\n" \
"MAX TTL.............................: <%ld> day(s), message id = <%.*s>\n"            \
