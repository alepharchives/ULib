...
inline void Messaggio::allocDestinatari(int n)
{
   ...
   (void) memset(vdestinatari_avvenuta_consegna,      '0', n);
   (void) memset(vdestinatari_rilevazione_virus,      '0', n);
   (void) memset(vdestinatari_mancata_consegna_virus, '0', n);
...
U_EXPORT istream& operator>>(istream& is, Messaggio& m)
{
   ...
   m.allocDestinatari(num_destinatari);
