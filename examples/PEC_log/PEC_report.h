...
public:
   ...
   static time_t getTime()
      ...
      time_t t = UDate::getSecondFromTime(line->c_pointer(U_LINEDATA+1));
...
protected:
   UFileConfig cfg;
   UString cfg_config, cfg_suffix, cfg_domain, cfg_id, cfg_from, cfg_to;
   ...
   static void processFile(UStringRep* key, void* elem);
